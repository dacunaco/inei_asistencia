...
app.controller('OpcionesController', function($scope, $mdBottomSheet, $window) {
  $scope.items = [
    { name: '', icon: 'logout', color: 'black', action: 'user/logout' },
  ];
  ...
  $scope.listItemClick = function($index) {
    ...
    $window.location.href = clickedItem.action;
  };
});
